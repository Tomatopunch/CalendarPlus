...
class CalendarViewController: UIViewController {
    ...
    @IBOutlet weak var UILabelWind: UILabel!
    ...
    func setUI(){
        ...
        uiDesign.setSubTitleText(titleLabel: UILabelWindSpeed)
        uiDesign.setSubTitleText(titleLabel: UILabelPosition)
        uiDesign.setSubTitleText(titleLabel: UILabelWindDirection)
        uiDesign.setSubTitleText(titleLabel: UILabelWeatherDescription)
        uiDesign.setSubTitleText(titleLabel: UILabelWind)
     }
